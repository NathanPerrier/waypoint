...
export async function placeSuggestion(app) {
    const url = ` https://api.mapbox.com/v4/mapbox.mapbox-streets-v8/tilequery/${app.USER_LOCATION[0]},${app.USER_LOCATION[1]}.json?radius=${app.AR_SUGGESTION_RADIUS}&dedupe=false&glayers=poi_label&eometry=point&access_token=${app.MAPBOX_ACCESS_TOKEN}`;
